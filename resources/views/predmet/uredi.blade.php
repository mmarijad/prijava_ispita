                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('predmet.uredi', $predmet->id)}}" method="POST">
                                @csrf <!-- Svaka forma mora imati CSRF token! -->

                                <div class="form-group">
                                    <label for="ime">Naziv *</label>
                                    <input name="ime" type="text" class="form-control" placeholder="Unesite naziv...*" value = "{{$predmet->ime}}" required>
                                    
                                </div>
                                <div class="form-group">
                                    <label for="ECTS">ECTS *</label>
                                    <input name="ECTS" type="text" class="form-control" placeholder="Unesite ECTS...*" value = "{{$predmet->ECTS}}" required>
                                </div>
                                <div class="form-group">
                                    <label for="studij_id">Studij *</label>
                                    <select class="form-control" name="studij_id" required> 
