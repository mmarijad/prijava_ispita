                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                                ...
                                <h2 style="margin-top: 5px; font-family: 'Montserrat';">Ispitni rok</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('rokovi.uredi', $rok->id) }}" method="POST">
                            <hr>
                               <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="akademska_godina" type="text" class="form-control" placeholder="Unesite akademsku godinu...*" value="{{ $rok->akademska_godina }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="vrijeme_odrzavanja">Vrijeme održavanja *</label>
                                    <input type="text" class="form-control datetimepicker" name="vrijeme_odrzavanja" placeholder="Odaberite vrijeme održavanja...*"  value="{{ $rok->vrijeme_odrzavanja }}"  required> 
                                </div>
